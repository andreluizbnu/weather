...
function forecastService($resource, CLIENT_ID, CLIENT_KEY) {
    ...
    _getObservation = function () {
        return $resource('http://api.aerisapi.com/observations/:lat,:lng?client_id=' + CLIENT_ID + '&client_secret=' + CLIENT_KEY, {
            lat: '@lat',
            lng: '@lng'
        }, {
            query: {method: 'GET', isArray: false}
    ...
    return {
        ...
        getObservation: _getObservation()
    }
